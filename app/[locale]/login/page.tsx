...
export default async function LoginPage({
  ...
  return (
    <>
      <PageHero title={t("loginTitle")} intro={t("loginIntro")} />
      <div className="mx-auto max-w-sm px-4 py-14 sm:px-6 lg:px-8">
        <form className="space-y-5">
          <Field id="login-email" label={t("emailLabel")} type="email" />
          <Field id="login-password" label={t("passwordLabel")} type="password" />
